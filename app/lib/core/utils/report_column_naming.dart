...
const _columnKeys = <String>{
  'date', 'description', 'entry_by', 'debit', 'credit', 'running_balance',
  'name', 'route', 'phone', 'area', 'balance', 'type', 'amount',
  'shop', 'shop_name', 'stock_sold', 'revenue', 'outstanding',
  'variant_name', 'stock_pairs', 'bad_debt_amount',
  'item_number', 'size', 'color', 'qty', 'unit_price', 'total',
  'lbl_variant_name', 'lbl_quantity_available',
};
