...
const Map<AppLocale, Map<String, String>> _translations = {
  ...
  AppLocale.en: {
    ...
    'err_export_no_data':
        'No data to export. Apply different filters or add records first.',
    'err_pdf_failed': 'PDF generation failed.',
    ...
    'select_customer': 'Please select a shop',
    ...
    // ── Shops ──
    'new_customer': 'New Shop',
    'edit_customer': 'Edit Shop',
    'customer_not_found': 'Shop not found',
    ...
    'spark_plan': 'Spark Plan',
    'firebase_free_tier_guard': 'Free tier usage guard',
    'read_limit': 'Read Limit',
    'firebase_read_guard': 'Firestore reads/day',
    'write_limit': 'Write Limit',
    'firebase_write_guard': 'Firestore writes/day',
    'add_user': 'Add User',
    ...
    'device_pairing_reset': 'Device pairing reset for',
    'device_pairing_enabled': 'Device pairing enabled',
    ...
    'perm_view_customers': 'View Shops',
    'perm_create_customers': 'Create Shops',
    'perm_edit_customers': 'Edit Shops',
    ...
    'update_customer': 'Update Shop',
    'add_customer': 'Add Shop',
    ...
    'no_customers_found': 'No shops found',
    ...
    'whatsapp_open_chat': 'Open Chat',
    'whatsapp_view_statement': 'View Account Statement',
    'payment_reminder_msg':
        'Hello %name%, your outstanding balance is %amount%. Please arrange payment at your earliest convenience.',
    'top_outstanding': 'Top Outstanding Accounts',
    ...
    'dashboard_pending_dues': 'Shops have pending dues',
    ...
    'dashboard_new_customer': 'New Shop',
    ...
    'tooltip_delete_customer': 'Delete shop',
    'confirm_delete_customer': 'Delete this shop?',
    ...
    'msg_no_customers_found': 'No shops found',
    ...
    'backup_auto_subtitle': 'Automatically export on app open when due',
    'backup_interval': 'Back up every',
    'backup_interval_1': 'Daily',
    'backup_interval_3': 'Every 3 days',
    'backup_interval_7': 'Weekly',
    'backup_interval_14': 'Every 2 weeks',
    ...
    'backup_restore_proceed': 'Restore',
    'backup_restore_in_progress': 'Restoring backup…',
    'backup_restore_success': 'Restore complete — %s records restored',
    'backup_restore_invalid': 'Invalid or unreadable backup file',
    'backup_no_local': 'No saved backups found. Create a backup first.',
    'backup_pick_file': 'Select Backup',
    'backup_created_at': 'Created: %s',
    'backup_app_version': 'App version: %s',
    'backup_total_records': 'Total records: %s',
  ...
  AppLocale.ar: {
    ...
    'err_export_no_data':
        'لا توجد بيانات للتصدير. جرّب فلاتر مختلفة أو أضف سجلات أولاً.',
    'err_pdf_failed': 'فشل إنشاء PDF.',
    ...
    'select_customer': 'الرجاء اختيار محل',
    ...
    // ── Shops ──
    'new_customer': 'محل جديد',
    'edit_customer': 'تعديل المحل',
    'customer_not_found': 'المحل غير موجود',
    ...
    'active_workspaces': 'المساحات النشطة',
    'spark_plan': 'خطة Spark',
    'firebase_free_tier_guard': 'حارس استخدام الطبقة المجانية',
    'read_limit': 'حد القراءة',
    'firebase_read_guard': 'قراءات Firestore / يوم',
    'write_limit': 'حد الكتابة',
    'firebase_write_guard': 'كتابات Firestore / يوم',
    ...
    'device_pairing_reset': 'تم إعادة تعيين اقتران الجهاز لـ',
    'device_pairing_enabled': 'تم تمكين اقتران الجهاز',
    ...
    'perm_view_customers': 'عرض المحلات',
    'perm_create_customers': 'إنشاء المحلات',
    'perm_edit_customers': 'تعديل المحلات',
    ...
    'update_customer': 'تحديث المحل',
    'add_customer': 'إضافة محل',
    ...
    'no_customers_found': 'لم يتم العثور على محلات',
    ...
    'whatsapp_open_chat': 'فتح المحادثة',
    'whatsapp_view_statement': 'عرض كشف الحساب',
    'payment_reminder_msg':
        'مرحباً %name%، رصيدك المستحق هو %amount%. يرجى ترتيب الدفع في أقرب وقت ممكن.',
    'top_outstanding': 'أعلى الحسابات المستحقة',
    'outstanding': 'مستحق',
    ...
    'sale_credit': 'آجل',
    'sale_type': 'نوع البيع',
    'customers_report': 'تقرير المحلات',
    ...
    'dashboard_new_customer': 'محل جديد',
    ...
    'tooltip_delete_customer': 'حذف المحل',
    'confirm_delete_customer': 'هل تريد حذف هذا المحل؟',
    ...
    'msg_no_customers_found': 'لا يوجد محلات',
    ...
    'backup_auto_subtitle': 'تصدير تلقائي عند فتح التطبيق عند الاستحقاق',
    'backup_interval': 'نسخ كل',
    'backup_interval_1': 'يومياً',
    'backup_interval_3': 'كل 3 أيام',
    'backup_interval_7': 'أسبوعياً',
    'backup_interval_14': 'كل أسبوعين',
    ...
    'backup_restore_proceed': 'استعادة',
    'backup_restore_in_progress': 'جارٍ استعادة النسخة…',
    'backup_restore_success': 'اكتملت الاستعادة — %s سجل',
    'backup_restore_invalid': 'ملف نسخة احتياطية غير صالح',
    'backup_no_local': 'لم يتم العثور على نسخ احتياطية. أنشئ نسخة أولاً.',
    'backup_pick_file': 'اختر نسخة',
    'backup_created_at': 'تاريخ الإنشاء: %s',
    'backup_app_version': 'إصدار التطبيق: %s',
    'backup_total_records': 'إجمالي السجلات: %s',
  ...
  AppLocale.ur: {
    ...
    'err_export_no_data':
        'ایکسپورٹ کے لیے کوئی ڈیٹا نہیں۔ مختلف فلٹرز آزمائیں یا پہلے ریکارڈز شامل کریں۔',
    'err_pdf_failed': 'PDF بنانے میں ناکامی۔',
    ...
    'select_customer': 'براہ کرم دکان منتخب کریں',
    ...
    // ── Shops ──
    'new_customer': 'نئی دکان',
    'edit_customer': 'دکان میں ترمیم',
    'customer_not_found': 'دکان نہیں ملی',
    ...
    'active_workspaces': 'فعال ورک اسپیسز',
    'spark_plan': 'اسپارک پلان',
    'firebase_free_tier_guard': 'فری ٹائر استعمال گارڈ',
    'read_limit': 'ریڈ حد',
    'firebase_read_guard': 'Firestore ریڈز / دن',
    'write_limit': 'رائٹ حد',
    'firebase_write_guard': 'Firestore رائٹس / دن',
    ...
    'device_pairing_reset': 'ڈیوائس جوڑا دوبارہ سیٹ کیا گیا ہے',
    'device_pairing_enabled': 'ڈیوائس جوڑا فعال ہے',
    ...
    'perm_view_customers': 'دکانیں دیکھیں',
    'perm_create_customers': 'دکانیں بنائیں',
    'perm_edit_customers': 'دکانیں میں ترمیم',
    ...
    'update_customer': 'دکان اپ ڈیٹ کریں',
    'add_customer': 'دکان شامل کریں',
    ...
    'no_customers_found': 'کوئی دکان نہیں ملی',
    ...
    'whatsapp_open_chat': 'چیٹ کھولیں',
    'whatsapp_view_statement': 'اکاؤنٹ اسٹیٹمنٹ دیکھیں',
    'payment_reminder_msg':
        'السلام علیکم %name%، آپ کا واجب الادا بیلنس %amount% ہے۔ براہ کرم جلد از جلد ادائیگی کا بندوبست فرمائیں۔',
    'top_outstanding': 'سب سے زیادہ واجب الادا',
    ...
    'customers_report': 'دکانوں کی رپورٹ',
    ...
    'dashboard_new_customer': 'نئی دکان',
    ...
    'tooltip_delete_customer': 'دکان حذف کریں',
    'confirm_delete_customer': 'کیا آپ اس دکان کو حذف کرنا چاہتے ہیں؟',
    ...
    'msg_no_customers_found': 'کوئی دکان نہیں ملی',
    ...
    'backup_auto_subtitle': 'اپلیکیشن کھلنے پر خودکار ایکسپورٹ',
    'backup_interval': 'ہر',
    'backup_interval_1': 'روزانہ',
    'backup_interval_3': 'ہر 3 دن',
    'backup_interval_7': 'ہفتہ وار',
    ...
    'backup_restore_proceed': 'ریسٹور',
    'backup_restore_in_progress': 'بیک اپ ریسٹور ہو رہی ہے…',
    'backup_restore_success': 'ریسٹور مکمل — %s ریکارڈز',
    'backup_restore_invalid': 'غلط یا ناقابل پڑھ بیک اپ فائل',
    'backup_no_local': 'کوئی بیک اپ محفوظ نہیں۔ پہلے بیک اپ بنائیں۔',
    'backup_pick_file': 'بیک اپ منتخب کریں',
    'backup_created_at': 'بنایا گیا: %s',
    'backup_app_version': 'ایپ ورژن: %s',
    'backup_total_records': 'کل ریکارڈز: %s',
