  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return txsAsync.when(
      ...
      data: (txs) {
        ...
        // Take last 6 months
        final periods =
            AppFormatters.last12Periods().reversed
                .take(6)
                .toList()
                .reversed
                .toList();
...
class _OutstandingPieChart extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return shopsAsync.when(
      ...
      data: (shops) {
        final withDebt =
            shops.where((s) => s.balance > 0).toList()
        ...
        child: Column(
          ...
          children: [
            ...
            shopsAsync.when(
              ...
              data:
                  (shops) => DropdownButtonFormField<String>(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed:
                    _selectedShopId == null || _generating ? null : _generate,
                icon:
                    _generating
                        ? const SizedBox(
                          width: 18,
