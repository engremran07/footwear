...
1. Verify all queries with `.collection(constant)` still resolve

1. Update `firestore.rules` match paths

1. Update `firestore.indexes.json` collection names

1. Update ALL 5 docs: `AGENTS.md`, `CLAUDE.md`, `README.md`, `app/README.md`, `SYSTEM_DEEP_DIVE_2026-03-27.md`

1. Re-deploy rules + indexes

## Adding a New Collection

1. Add constant to `collections.dart`

1. Add rules block to `firestore.rules` (deny-by-default)

1. Add to canonical list in `AGENTS.md §1`

1. Add composite indexes as required

1. Add to this instructions file
